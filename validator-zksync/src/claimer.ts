...
export function handleTransfer(event: TransferEvent): void {
  ...
  entity.save()
  //Update holder
  let tokenHolder = ClaimerTokenHolder.load(event.params.tokenId.toString());
  if (tokenHolder == null) {
    tokenHolder = new ClaimerTokenHolder(event.params.tokenId.toString());
